...
class Classifier(object):
    ...
    def build_model(self):
        ...
        self.opt = optim.Adam(self.SpeakerClassifier.parameters(), lr=1e-3, betas=(0.5, 0.9))
    ...
    def get_data_loaders(self, data_dir):
        ...
        self.train_dataset = ClassifyDataset(
                ...
                os.path.join(data_dir, 'train_speakers.txt'),
                emotion='ang',
                segment_size=128)
        ...
        self.val_dataset = ClassifyDataset(
                ...
                os.path.join(data_dir, 'test_speakers.txt'),
                emotion='ang',
                segment_size=128)
        ...
        for iteration in range(iters):
            ...
            if iteration % 5000 == 0 and iteration != 0:
                ...
                if valid_acc > best_val_acc: 
                    ...
                    print('Save Model...{:.4f} acc'.format(best_val_acc))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-output_model_path', default='model_Classifier_512_ang/')
